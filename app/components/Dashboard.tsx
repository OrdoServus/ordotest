...
const s: { [key: string]: any } = {
  ...
  banner:         { backgroundColor: '#e8f4fd', border: '1px solid #b3d9ff', borderRadius: '8px', padding: '12px 20px', marginBottom: '24px', textAlign: 'center', color: '#2c3e50', fontSize: '0.95rem', width: 'calc(100% - 40px)', maxWidth: '1000px' },
  bannerLink:     { color: '#007bff', textDecoration: 'none' },
  upcomingWrapper:{ width: '100%', maxWidth: '1000px', padding: '0 20px', marginBottom: '28px' },
  grid:           { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '28px', width: '100%', maxWidth: '1000px', marginBottom: '50px', padding: '0 20px' },
  ...
  footer:         { padding: '36px 20px', textAlign: 'center', backgroundColor: '#2c3e50', color: 'white', width: '100%' },
