...
export default function GottesdienstEditor({ titel, inhalt, onTitelChange, onInhaltChange, onSpeichern, document }: EditorProps) {
  ...
  // Toolbar for the Gottesdienst editor
  const toolbar = (
